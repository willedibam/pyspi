...
| `xcorr_*`, `xcorr-sq_*` (6) | Biased normalisation, demeaning, a symmetric lag window, Bartlett's significance band, and a `sigonly` rule invariant under l → −l. |
