...
**Values changed** — this pass additionally changes the three phase means; the strict KSG fix changes no frozen array. The existing comparison below is against 2.0.1 on the frozen fixtures at rtol 1e-9.
