...
heatmap, and gives the CLI equivalent.
...
locally. Both execute top to bottom with no manual steps; `01` takes roughly 45 s
(dominated by the `sonnet` config) and `02` roughly 7 s.
